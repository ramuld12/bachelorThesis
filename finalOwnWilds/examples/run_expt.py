...
def main():
    ...
    parser.add_argument('--target_eps', type=float, default=1.0)
    parser.add_argument('--target_delta', type=float, default=1e-05)
    parser.add_argument('--sample_rate', type=float, default = 0.01)
    parser.add_argument('--dp_max_grad_norm', type=float, default=1.2)
    parser.add_argument('--freeze_bert', type=parse_bool, default=True)
    parser.add_argument('--useDP', type=parse_bool, default=True)
